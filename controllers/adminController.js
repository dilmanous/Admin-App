app.controller('adminController',function($scope,$http)
{
  ...
  */
   ...
   */
    ...
    {
      $http.get("http://localhost/xampp/MedicalPortal/CreateAdmin.php?FirstName='"+FirstName+"'&LastName='"+LastName+"'&Username='"+Username+"'&Password='"+Password+"'").success(function (response)
      {
   ...
   */
    ...
    {
      $http.get("http://localhost/xampp/MedicalPortal/RemoveAdmin.php?AdminSerNum="+adminsernum).success(function (response)
      {
   ...
   */
    $http.get("http://localhost/xampp/MedicalPortal/GetAdmins.php").success(function (response)
    {
