app.controller('appointmentController',function($rootScope,$scope,$location,$anchorScroll,$http)
{
  ...
  */
       ...
       */
        ...
        {
          $http.get("http://localhost/xampp/MedicalPortal/RemoveAppointmentRequest.php?RequestSerNum="+$scope.Requests[key].RequestSerNum).success(function (response)
          {
            $scope.GetRequests();
          });
        }
       ...
       * @requires $http
       */
        var changeAppURL="http://localhost/xampp/MedicalPortal/ChangeAppointment.php?AppointmentSerNum='"+$scope.Requests[$scope.key].AppointmentSerNum+"'&newStartTime='"+$scope.newStartTime.toISOString()+"'&newEndTime='"+$scope.newEndTime.toISOString()+"'";
       ...
       */
          $http.get("http://localhost/xampp/MedicalPortal/GetAppointmentChanges.php").success(function (response)
          {
