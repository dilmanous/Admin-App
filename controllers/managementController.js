...
//  $scope.alerts={foundAlert:{message:'',type:''} , removeAlert:{message:'',type:''}};
       ...
       */
        if (key=="Language" || key=="Alias" || key=="EnableSMS" || key=="FirstName" || key=="LastName" || key=="PatientId" || key=="TelNumForSMS" || key=="SSN")
        {
          ...
          if(newValue)
          {
            var changeURL="http://localhost/xampp/MedicalPortal/ChangeValue.php?fieldToChange='"+key+"'&newValue='"+newValue+"'&PatientSerNum='"+$scope.PatientInfo[0].PatientSerNum+"'";
      ...
      $scope.FindPatient= function ()
         ...
         */
          ...
          var doctorURL="http://localhost/xampp/MedicalPortal/GetDoctors.php?";
          var activityURL="http://localhost/xampp/MedicalPortal/GetActivities.php?";
          var appointmentURL="http://localhost/xampp/MedicalPortal/GetAppointments.php?";
          if ($scope.LastName)
          {
    ...
    $scope.RemoveUser=function()
       ...
       */
        ...
        if (areYouSure)
         {
            var RemoveURL="http://localhost/xampp/MedicalPortal/RemoveUser.php?PatientId="+$scope.PatientId;
