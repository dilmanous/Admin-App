  ...
  */
       ...
       */
          ...
          file.upload = Upload.upload({
            url: 'http://localhost/xampp/MedicalPortal/SendFile.php',
            method: 'POST',
            headers: {
        ...
        'message':messageArray } ,
          ...
          $scope.FindPatient = function ()
             ...
             */
              var patientURL="http://localhost/xampp/MedicalPortal/MySQLFind.php?";
              if ($scope.LastName)
              {
     ...
     */
      $http.get("http://localhost/xampp/MedicalPortal/GetMessages.php?Username='"+$rootScope.currentUser+"'").success(function(response)
      {
     ...
     */
      $http.get("http://localhost/xampp/MedicalPortal/SendMessage.php?SenderSerNum="+$rootScope.Admin.AdminSerNum+"&ReceiverSerNum="+$scope.currentConversation+"&MessageContent="+$scope.newMessage).success(function(response)
      {
     ...
     */
      for (var message in $scope.Conversations[currentconversation])
      {
        ...
        {
          $http.get("http://localhost/xampp/MedicalPortal/ReadMessage.php?MessageSerNum='"+message.MessageSerNum+"'").success(function(response)
          {
