  ...
  */
   ...
   */
     if ($scope.SSN.length>11){
        var msURL="http://172.16.220.174/devDocuments/mehryar/qplus/FindPatient.php?PatientSSN="+ssn;
                          ...
                          if (error)
                          {
                            ...
                            $(document).ready(function()
                            {
                                $("#firebaseError").append("<p class='bg-danger'>An Error occured while creating user: </p>");
                                  ...
                                  $scope.myURL="http://172.16.220.174/devDocuments/mehryar/qplus/MysqlRegister.php?PatientSerNum="
